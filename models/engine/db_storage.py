...
class DBStorage:
    """
        This class manage the storage in a mysql database
    """
    __engine = None
    __session = None
    ...
    def all(self, cls=None):
        """ Return a dictionary of a model onbject in storage """
        obj_dict = {}
        all_models = {
                'State': State,
                'City': City,
    ...
    def save(self):
        """Commit the add object to the database"""
        DBStorage.__session.commit()

    def reload(self):
        """Reload the database storage engine"""
